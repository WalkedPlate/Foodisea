...
public class SuperAdminAgregarAdministradorActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void setupListeners() {
        ...
        binding.btnCrearAdministrador.setOnClickListener(v -> attemptRegister());
    }
    ...
    private void proceedWithRegistration(Uri photoUri) {
        ...
        usuarioRepository.registerUser(
            ...
            startActivity(new Intent(this, ActivitySuperAdminGestionAdministradoresBinding.class));
            finish();
    ...
    private Usuario createUserObject() {
        ...
        nuevoUsuario = new AdministradorRestaurante();
        ...
        nuevoUsuario.setTipoUsuario("AdministradorRestaurante");
