...
public class ClienteChangePasswordActivity extends AppCompatActivity {

    ActivityClienteChangePasswordBinding binding;
    ...
    private void initializeComponents() {
        binding = ActivityClienteChangePasswordBinding.inflate(getLayoutInflater());
